...
app.get('/consolidated_charge', async (req, res) => {
    try {
        const { amd_num, ru, ru_status, ru_service_cat, ru_id, created_from, created_to, updated_from, updated_to, last_sign_date, last_sign_date_from, last_sign_date_to, limit, offset, order_by, order_dir } = req.query;
        const filters = {
            amd_num,
            ru: parseArrayParam(ru),
            ru_status: parseArrayParam(ru_status),
            ru_service_cat: parseArrayParam(ru_service_cat),
            ru_id: parseArrayParam(ru_id),
            created_from,
            created_to,
            updated_from,
            updated_to,
...
app.get('/ingestion_volume', async (req, res) => {
    try {
        const { amd_num, ru, ru_status, ru_id, created_from, created_to, updated_from, updated_to, last_sign_date, last_sign_date_from, last_sign_date_to, limit, offset, order_by, order_dir } = req.query;
        const filters = {
            amd_num,
            ru: parseArrayParam(ru),
            ru_status: parseArrayParam(ru_status),
